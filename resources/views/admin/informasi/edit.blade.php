...
@section('content')
    <div class="container">
        <h3 class="mb-4 fw-bold">Edit Informasi</h3>
                ...
                <form action="{{ route('informasi.update', $informasi->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="bulan_id"
                            ...
                            @foreach ($bulans as $b)
                                <option value="{{ $b->id }}"
                                    {{ old('bulan_id', $informasi->bulan_id) == $b->id ? 'selected' : '' }}>
                                    {{ $b->nama_bulan }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" rows="5"
                            class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $informasi->keterangan) }}</textarea>
